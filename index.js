function init() {
      ...
      if (keyEvent.key =="ArrowRight"){
        ...
        if(counter > 0){
          ...
          console.log("left key was pressed below 0")
                                                                                                  ...
                                                                                                  ///  SHOW SLIDE FOR THIS SHOWING NESTED IF/ELSE TREE
    }
  console.log("scrollHandler invoked: takes jokeData, keyEvent, buttonEvent as arguments: contains nested if/else statements for identifying keyEvent.key, has a counter, iterates through jokeData.jokes invoking determineJokeTypeCat(jokeData.jokes[counter])when key is pressed, calls jokeMaxHandler and reset counter when counter reaches index 9 in array")
  }
  ...
  console.log("OnePartBtnClickHandler invoked: invokes renderSubmitButton, renderTwoPartBtn, createCategoryList, submitOnePartListener, builds form for 1 part joke, e.target.parentNode.inner HTML blankout")  
    ...
    function twoPartBtnClickHandler(event) 
    {                                          // "two part button click"
